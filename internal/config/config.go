...
type PKIConfig struct {
	ServerRenewBefore string   `yaml:"server_renew_before,omitempty"`
	ClientRenewBefore string   `yaml:"client_renew_before,omitempty"`
	CheckInterval     string   `yaml:"check_interval,omitempty"`
	CAOverlap         string   `yaml:"ca_overlap,omitempty"`
